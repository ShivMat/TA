...
if (session != null && session.getAttribute("DS") != null) {
...
<head>
    <meta charset="UTF-8">
    <title>Development Staff Home</title>
    <style>
...
<div class="container">
<h1>Welcome Development Staff</h1> <a href="Logout.jsp"><img src="logout.png" width=50 height=50></a>
    <div class="menu">
        <div onclick="showDiv('inputCourses')">Input Courses</div>
        <div onclick="showDiv('viewCourses')">View Courses</div>
        <div onclick="showDiv('viewTAs')">View TAs</div>
        <div onclick="showDiv('check')">Check</div>
    </div>
...
<div class="form-container">
    <form action="AddCourseProcessor.jsp" method="post">
        <!-- Course ID will be auto-generated in the processor -->
        <label for="courseName">Course Name:</label>
        <input type="text" id="courseName" name="courseName" required>

        <label for="description">Description:(Max 250)</label>
...
<body>
    ...
    <table border="1">
        <tr>
            ...
            <th>Other Courses</th>
            <th>Resume</th>
             <th>Recommend to TA Committee</th>
        </tr>
        ...
        <% for (JobApplication k : applications) { %>
            <tr>
                ...
                else if (status.equals("Recommeded to Commitee"))
                {
                %>
                 <td> Recommended To TA</td>
                <%
                }
                else if (status.equals("Applied"))
                {
                %>
                	<td><a href="RecommedTA.jsp?status=<%=k.getApplication_id()%>"><img src="2.jpg" width=30 height=30 ></a></td>
                 <%
                }
                %>
            </tr>
